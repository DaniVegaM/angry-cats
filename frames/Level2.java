...
public class Level2 extends JPanel implements KeyListener {
        ...
        Timer timer = new Timer(5, new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (puntaje >= 1800) {
                    ...
                    panel.add(label);
                    JOptionPane.showMessageDialog(Level2.this, panel, "¡Felicitaciones!", JOptionPane.PLAIN_MESSAGE);
                    ...
                    Window window = SwingUtilities.getWindowAncestor(Level2.this);
                    window.dispatchEvent(new WindowEvent(window, WindowEvent.WINDOW_CLOSING));
                    ((Timer) e.getSource()).stop(); // Detener el timer
                } else if (puntaje < 1800 && numGato == 8) {
                    //Mensaje perdedor
                    ...
                    panel1.add(label1);
                    JOptionPane.showMessageDialog(Level2.this, panel1, "¡No le sabes!", JOptionPane.PLAIN_MESSAGE);
                    System.out.println("Ya se va a cerrar el frame");
                    clip1.stop();
                    clip1.close();
                    clip2.stop();
    ...
    private double velocidad = 4.2; // Esta es nuestra velocidad inicial
    ...
    public Level2() {
        ...
        reproducirSonido("./resources/opcion2.wav");
        // Cargamos las imagenes
        palo = new Palo[numNiveles * numPaloPorNivel * 2];
        gato = new Cat2("./resources/cat1.png", this);
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                ...
                level2.setGatoPositionListener(level2.gato);
