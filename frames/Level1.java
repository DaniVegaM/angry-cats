...
public class Level1 extends JPanel implements KeyListener {
        ...
        Timer timer = new Timer(5, new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (puntaje >= 600) {
                    ...
                    panel.add(label);
                    JOptionPane.showMessageDialog(Level1.this, panel, "¡Felicitaciones!", JOptionPane.PLAIN_MESSAGE);
                    ...
                    Window window = SwingUtilities.getWindowAncestor(Level1.this);
                    window.dispatchEvent(new WindowEvent(window, WindowEvent.WINDOW_CLOSING));
                    ((Timer) e.getSource()).stop(); // Detener el timer
                } else if (puntaje < 600 && numGato == 3) {
                    //Mensaje perdedor
                    ...
                    panel1.add(label1);
                    JOptionPane.showMessageDialog(Level1.this, panel1, "¡No le sabes!", JOptionPane.PLAIN_MESSAGE);
                    System.out.println("Ya se va a cerrar el frame");
                    clip1.stop();
                    clip1.close();
                    clip2.stop();
    ...
    private double velocidad = 3.6; // Esta es nuestra velocidad inicial
    ...
    public Level1() {
        ...
        reproducirSonido("./resources/opcion1.wav");
        // Cargamos las imagenes
        palo = new Palo[numNiveles * numPaloPorNivel];
        gato = new Cat1("./resources/cat1.png", this);
...
//Generador de estructuras de Palos y pescados
        ...
        for (int i = 0; i < numPeces; i++) {
            ...
            if (numA == 1 || numA == 2) {
                ...
                pescado[i] = new Pez(1000, 480 - (3 * i) * 32, "./resources/bigfish.png", numA);
            }
        }
...
//            }
    ...
    public void rebote(double vx, double vy) {
        ...
        Timer timer = new Timer(10, new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                // Incrementamos el tiempo
                time += 0.1;
                repaint(); //Se va actualizando el dibujo d
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                framel1 = new JFrame("AngryCats");
                framel1.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
                framel1.add(level1);
                framel1.dispose();
                ...
                framel1.pack();
                framel1.setLocationRelativeTo(null);
